...
*/
var TOKEN = '<1473365026:AAGM-pZH8-F02ns-KW2gxdWdzyUVJPmfVd8>';
var DELIMETER = ':::';
...
var MSG_START 			= "Hey :) \nFind Your Missed Online Sessions Using Me 🎃";
var MSG_DEFAULT 		= "Select The Option You Want";
...
var BUTTON = function(key, _mode){
	...
	if(key != bot.init.menu_root){
		var btns_in_line = [{ text: bot.emoji.get('sparkles') + " " + menu[key].parrent }];
		if(menu[key].parrent != bot.init.menu_root)
			btns_in_line.push({ text: bot.emoji.get('sparkles') + " " + bot.init.menu_root });
